...
def perfil(id_usuario):
    if int(id_usuario) == int(current_user.id):
        # o usuário está vendo o proprio perfil
        form_foto = FormFoto()
...
@login_required
def feed():
    fotos = Foto.query.order_by(Foto.data_criacao.desc()).all()[:100] #caso queira pegar as 100 primeiras fotos
